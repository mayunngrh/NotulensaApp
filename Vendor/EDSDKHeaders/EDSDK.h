...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsCreateFlashSettingRef(
                                EdsCameraRef		inCameraRef,
...
/*-----------------------------------------------------------------------------
//
//  Function:   EdsGetCsdFileData
//
//  Description:
//      Downloads a camera settings file on a remote camera to the host computer.
//      The downloaded file is sent directly to a file stream created in advance. 
//
//  Parameters:
//       In:    inCameraRef - The reference of the camera.
...
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsGetCsdFileData(EdsCameraRef inCameraRef,
                                    EdsStreamRef outStream);

/*-----------------------------------------------------------------------------
//
//  Function:   EdsSetCsdFileData
//
//  Description:
//      Writes the contents of the camera settings file to the remote camera.
//
//  Parameters:
//       In:    inCameraRef - The reference of the camera.
//              inDataSize - The number of bytes of the prepared buffer
//                  for set value.
//              inDataValue - The buffer pointer to set value.
//      Out:    None
//
//  Returns:    Any of the sdk errors.
-----------------------------------------------------------------------------*/
EdsError EDSAPI EdsSetCsdFileData(EdsCameraRef inCameraRef, 
                                  EdsInt32 inDataSize,
                                  EdsVoid* inDataValue);
